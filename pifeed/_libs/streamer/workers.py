...
# feeder for both pipelines (recorder + streamer) from the single camera
class CameraFeeder:
...
class RecorderWorker:
    def __init__(self: Self, config: DroneConfig, statq: (MessageQueue | None) = None) -> None:
        ...
        # flush current chunk instead of killling midway
        try:
    ...
    def _handle_signal(self: Self, _signum, _frame) -> None:
        try:
            self.stop()
        except Exception:
            pass
